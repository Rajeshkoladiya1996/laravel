    	...
    	try{
            ...
            foreach ($streamlist1->data->channels as $key=> $value) {
                ...
                if($user!=""){   
                    ...
                    $streamlist[$key]['webRTCViewerCount']=$value->user_count == 0 ? 0 : $value->user_count - 1;
                    ...
                    if (!filter_var($user->profile_pic, FILTER_VALIDATE_URL)) {                  
                        ...
                        $streamlist[$key]['profile_pic']=$user->profile_pic;
                    }
            ...
            foreach ($streamlist1->data->channels as $key=> $value) {
                ...
                $streamlistbattel[$key]['webRTCViewerCount']=$value->user_count == 0 ? 0 : $value->user_count - 1;
            ...
            return view('admin.liveStream.index',compact('streamlist','streamlistbattel'));
    ...
    public function liveStreamList(Request $request)
    {
    	try{
            ...
            if($request->type=="solo"){
                ...
                return view('admin.liveStream.streamList', compact('streamlist'));
                ...
                return view('admin.liveStream.battlesList', compact('streamlistbattel'));
            }    
