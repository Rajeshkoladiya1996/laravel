              ...
              <input type="hidden" name="id" id="update_component_id" /> 
                ...
                <div class="gift-input">
                    <label for="edit_component_image" class="gift-label">
                        ...
                        <div class="upload-box upload-box2">
                            <span class="smaller-img" id="img"><img class="preview-img edit-preview-img" src="{{URL::to('storage/app/public/Adminassets/image/gift-2.svg')}}" alt=""></span>
                            <h6>component Image</h6>
                        </div>
...
function readURLgif(input) {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.component.image){
                    $('.edit-preview-img').attr('src',"{{URL::to('storage/app/public/uploads/avtar/component')}}"+"/"+data.component.image);
                }else{
    ...
    function getcomponentlist() {
        $.ajax({
            url:"{{ route('admin.avtar.componentlist') }}",
            type:'GET',
            success:function(response){
                $('#componentList').html(response);
