...
@section('content')
  ...
  <div class="nav nav-tabs my-nav active" id="nav-tab" role="tablist">
      <a class="nav-item nav-link active tab-listing toggle-btn" id="SoloList-tab" data-toggle="tab" href="#SoloList" role="tab" aria-controls="levelList" aria-selected="false">Solo host</a>
      <a class="nav-item nav-link tab-listing toggle-btn" id="Pklist-tab" data-toggle="tab" href="#PkList" role="tab" aria-controls="points" aria-selected="true">Pk host</a>
  </div>
 </nav>
    <div class="tab-content" id="nav-tabContent">    
        <div class="tab-pane fade show active" id="SoloList" role="tabpanel" aria-labelledby="SoloList-tab">
           <div class="row" id="stream_list">
           
            @include('admin.liveStream2.streamList')
           </div>
            
        </div>
        <div class="tab-pane fade" id="PkList" role="tabpanel" aria-labelledby="Pklist-tab">
           <div class="row" id="pkbattels_list">
             @include('admin.liveStream2.battlesList')
           </div>
...
@endsection
@section('js')
<div class="modal fade live-modal" id="live-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="live-modalTitle" aria-hidden="true">
                ...
                <div class="col user-video-show live-video-auto">
                    <div id="remote-playerlist">
                        <div class="live-user-details pk-host-left-angle">
                            ...
                            <div class="live-user-profile">
                                <div class="live-user-profile-img">
                                    <div class="user-cap">
                                        <img src="{{asset('storage/app/public/Adminassets/image/ic_sworn.png')}}" alt="user-sticker">
                                    </div>
                                    <div class="user-profile">
                                        <img id="profile_pic" src="https://st2.depositphotos.com/1104517/11965/v/600/depositphotos_119659092-stock-illustration-male-avatar-profile-picture-vector.jpg" alt="user-profile" class="profile_pic">
                                    </div>
                                    <div class="user-country-flag">
                                        <img src="https://lh3.googleusercontent.com/kDFqpP2IdHOWzipHrsB1o0wbBgHZNR9_E3Prc0zUzAvQCHxiDhOqtupTz_oHjI36PIU=s200" alt="user-sticker">
                                    </div>
                                </div>
                                <div class="user-details">
                                    <p class="user-title" id="user_name"></p>
                                    <p><i class="fas fa-user mr-1"></i><span class="total_user_count" id="total_user_count">0</span></p>
                                    <p><i class="far fa-comment mr-1"></i><span class="total_chat_count" id="total_chat_count">0</span></p>
                                </div>
                            </div>
                            <div class="live-user-profile money-send-list">
                                <img src="{{asset('storage/app/public/Adminassets/image/pink-diamond.png')}}" alt="user-sticker" class="send-money-sticker">
                                <div class="user-details">
                        ...
                        <div class="live-user-details pk-host-right-angle" id="pk_battel" style="display:none;">
                            ...
                            <div class="live-user-profile">
                                ...
                                <div class="live-user-profile-img">
                                    ...
                                    <div class="user-profile">
                                        <img id="profile_pic1" src="https://st2.depositphotos.com/1104517/11965/v/600/depositphotos_119659092-stock-illustration-male-avatar-profile-picture-vector.jpg" alt="user-profile">
                                    </div>
                                    <div class="user-country-flag">
                                        <img src="https://lh3.googleusercontent.com/kDFqpP2IdHOWzipHrsB1o0wbBgHZNR9_E3Prc0zUzAvQCHxiDhOqtupTz_oHjI36PIU=s200" alt="user-sticker">
                                    </div>
                            ...
                            <div class="live-user-profile money-send-list">
                                ...
                                <img src="https://lh3.googleusercontent.com/kDFqpP2IdHOWzipHrsB1o0wbBgHZNR9_E3Prc0zUzAvQCHxiDhOqtupTz_oHjI36PIU=s200" alt="user-sticker" class="send-money-sticker">
                            </div>
                        </div>
                        ...
                        <div class="gift-pop-wrap">
                            <div class="gift-pop">
                                <img src="{{asset('storage/app/public/Adminassets/image/pink-diamond.png')}}" class="img-fluid bk-live-emoji-img" alt="" />
                            </div>
                        </div>
...
<script>
const server_url = "{{route('admin.liveStream2.view')}}";
const battles_url = "{{route('admin.liveStream2.battlesview')}}";
</script>
<script type="text/javascript" src="{{URL::to('storage/app/public/Adminassets/js/basicLive.js')}}"></script>
@endsection