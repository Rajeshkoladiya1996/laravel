<table id="example2" class="table td-wrap-table table-striped table-bordered dt-responsive nowrap mytabel" style="width:100%">
    ...
    <tbody>
        @php
            $i=0;
        @endphp
        @foreach ($rewardpointsList as $data)
            <tr>
                <td>{{ ++$i }}</td>
                <td>{{ $data->name }}</td>
                <td>{{ $data->day }}</td>
                ...
                <td>
                    <ul class="action-wrap">
                        <li>
                            <a href="javascript:void(0)" id="editRewardPoint" data-id="{{$data->id}}" data-type="rewardpointlist">
                           ...
                           <!--  <li>
                                <a href="javascript:void(0)" id="deleteReward" data-id="{{$data->id}}">
